...
[フォント変換サイト](https://cloudconvert.com/font-converter)

1. フォントファイルが`otf`なら`ttf`に変換する
2. サブセットメーカーで軽量化する
3. WOFFコンバーターでwoffに変換する
4. woffをwoff2に変換する
...
headタグにwebフォントpreloadする記述を追記
```
<link rel="preload" href="./fonts/ファイル名" as="font" type="font/woff2" crossorigin />
```
